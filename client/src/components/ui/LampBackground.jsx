...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}>
      <div
      ...
      <div className="relative z-50 flex flex-col items-center px-5 -mt-54 -translate-y-20">
        {children}
      </div>
    </div>
  );
